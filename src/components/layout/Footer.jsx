        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-4 xl:col-span-1">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold text-gray-900">Job Portal</span>
            </Link>
            <p className="text-gray-500 text-base max-w-md">
              Connecting talented professionals with amazing opportunities. Build your career with our comprehensive job portal platform.
            </p>
